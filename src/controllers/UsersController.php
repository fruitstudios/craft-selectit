<?php
namespace fruitstudios\selectit\controllers;
...
class UploadController extends Controller
{
    ...
    public function actionIndex()
    {
        ...
        if(!$asset)
        {
            return $this->asErrorJson(Craft::t('selectit', 'Could not get uploaded asset.'));
        }
        ...
        // Preview
        $html = SelectitHelper::renderTemplate('selectit/_macros/_preview', [
            'asset' => $asset,
            'name' => $name,
            'view' => $view,
            'transform' => $transform,
    ...
    public function actionCanUpload()
    {
        ...
        if(!$currentUser)
        {
            return $this->asErrorJson(Craft::t('selectit', 'Only logged in users can upload assets.'));
        }
        ...
        // {
        //     return $this->asErrorJson(Craft::t('selectit', 'You don\'t have permission to upload assets.'));
        // }
